...
class gsp_ttt_usershow_gsp extends GroovyPage {
...
printHtmlPart(18)
invokeTag('message','g',37,['code':("user.passWord.label"),'default':("Pass Word")],-1)
printHtmlPart(19)
...
printHtmlPart(24)
invokeTag('message','g',64,['code':("user.address.label"),'default':("Address")],-1)
printHtmlPart(25)
invokeTag('fieldValue','g',66,['bean':(userInstance),'field':("address")],-1)
printHtmlPart(16)
}
printHtmlPart(26)
createTagBody(2, {->
...
invokeTag('link','g',74,['class':("edit"),'action':("edit"),'resource':(userInstance)],3)
printHtmlPart(28)
...
invokeTag('form','g',77,['url':([resource:userInstance, action:'delete']),'method':("DELETE")],2)
printHtmlPart(30)
})
...
public static final long LAST_MODIFIED = 1414062762000L
