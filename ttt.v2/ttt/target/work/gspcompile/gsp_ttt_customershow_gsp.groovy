...
class gsp_ttt_customershow_gsp extends GroovyPage {
...
printHtmlPart(14)
invokeTag('message','g',28,['code':("customer.name.label"),'default':("Name")],-1)
printHtmlPart(15)
invokeTag('fieldValue','g',30,['bean':(customerInstance),'field':("name")],-1)
printHtmlPart(16)
}
printHtmlPart(17)
createTagBody(2, {->
...
invokeTag('link','g',38,['class':("edit"),'action':("edit"),'resource':(customerInstance)],3)
printHtmlPart(19)
...
invokeTag('form','g',41,['url':([resource:customerInstance, action:'delete']),'method':("DELETE")],2)
printHtmlPart(21)
})
...
public static final long LAST_MODIFIED = 1414045786000L
