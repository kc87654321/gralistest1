...
class gsp_ttt_userindex_gsp extends GroovyPage {
...
printHtmlPart(13)
invokeTag('sortableColumn','g',29,['property':("passWord"),'title':(message(code: 'user.passWord.label', default: 'Pass Word'))],-1)
printHtmlPart(13)
...
printHtmlPart(13)
invokeTag('sortableColumn','g',35,['property':("address"),'title':(message(code: 'user.address.label', default: 'Address'))],-1)
printHtmlPart(14)
loop:{
int i = 0
...
public static final long LAST_MODIFIED = 1414062756000L
